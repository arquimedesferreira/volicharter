...
<head>
	...
	<title>Volicharter</title>
	<meta name="keywords" content="air italy brasile, blu panorama brasile, volo charter brasile, volo di linea tap, voli di linea tam, voli di linea iberia, voli di linea air europa, fly brasil, voe brasil, todo brasil, volo fortaleza, volo natal, volo salvador, hotel in brasile, albergo in brasile, investimenti in brasile, case in brasile, acquista in brasile, voli per il brasile, tour in brasile, tour in buggy, passeio buggy natal, pousadas in brasile, appartamenti in brasile, appartamenti a fortaleza, appartamenti a natal, soggiorni in brasile, pacchetti brasile, pacchetti vacanza, offerte brasile, offerte viaggi, viaggi e soggiorno a fortaleza, pontanegra, praia de iracema, copacabana, ipanema, sao paolo, manaus, salvador de bahia, natal, recife, maceio, porto seguro, belo horizonte, porto allegre, pipa, curitiba, morro do sao paulo, fernando de noronha, jericoacoara, rio de janeiro, amazzonia, pantanal, carioca, agenzia viaggi, tour operator, informazione brasile, viaggi in brasile, tour del brasile, canoa quebrada, voli low cost brasile, alberghi in brasile, brasile last minute, voli last minute, voli low cost,  voli last second, brasile vacanze, brasile viaggi, brasile volo, cuba, cuba hotel, cuba last minute, cuba last second, cuba vacanza, cuba viaggi, cuba voli, compagnia aerea brasile, coppa del mondo calcio, copa do mundo 2014, mondiali di calcio, olimpiadi rio 2016">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-4630443-8']);
...
var mygallery=new fadeSlideShow({
	...
	dimensions: [728, 286], //width/height of gallery in pixels. Should reflect dimensions of largest image
	imagearray: [
		["/images/banner1.jpg"],
		["/images/banner2.jpg"],
		["/images/banner3.jpg"],
	...
	<div id="main" class="autoclr">	
		<div id="mainContent">
		  <div id="mainTop">
					...
					<form method="POST" action="http://www.brasilevoli.it/default.asp?cerca=true" name="form_ricerca">
					<table class="standardFormTable" border="0" style="width: 916px; height: 50px;">
						<tbody><tr>
					    	<td class="formSx" align="right">Cerca destinazione</td>
					    	<td></td>
					    	<td style="width: 768px">
					    	<select name="destinazione" class="EditSelect">
					    		<option value="tutte">tutte</option>
					    		
					    		  <option value="FORTALEZA SOLO ANDATA">fortaleza solo andata</option>
					    		  
					    		  <option value="FORTALEZA SOLO RITORNO">fortaleza solo ritorno</option>
					    ...
					    <tr>
					    	<td class="formSx" align="right">Aeroporto di 
							partenza</td>
					    	<td class="formMx"></td>
					    	<td class="formDx" style="width: 768px">
					    	<select name="partenza" class="EditSelect">
					    		<option value="tutti">tutti</option>
					    		
					    		  <option value="FORTALEZA">fortaleza</option>
					    		  
					    		  <option value="MILANO MXP">milano mxp</option>
					    		  					    	</select>
					    	</td>
					    </tr>
					    <tr>
					    	<td class="formSx" align="right">&nbsp;</td>
					    	<td class="formMx">&nbsp;</td>
					    	<td class="formDx" style="width: 768px">
					    	&nbsp;</td>
					    </tr>
		  ...
		  <div id="mainElenco">
			<table class="elenco" cellpadding="8" cellspacing="0">
				<tbody><tr>
					<td width="32%"><span class="darkbold">DESTINAZIONE</span></td>
					<td width="14%"><span class="darkbold">DATA PART.</span></td>
					<td width="18%"><span class="darkbold">DA/PER</span></td>
					<td width="14%"><span class="darkbold">DURATA</span></td>
					<td width="10%"><span class="darkbold">PREZZO</span></td>
					<td width="6%"><span class="darkbold"> DETTAGLI</span></td>
					<td width="6%"><span class="darkbold"> PRENOTA</span></td>					
				</tr>
...
<div id="skypedetectioncontainer" style="position: absolute; width: 5px; height: 5px; top: 0px; left: -10px; visibility: visible;"></div></body></html>